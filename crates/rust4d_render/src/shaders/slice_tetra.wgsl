...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    pos[0] = transform_4d(v0.position, camera_mat);
    pos[1] = transform_4d(v1.position, camera_mat);
    pos[2] = transform_4d(v2.position, camera_mat);
    pos[3] = transform_4d(v3.position, camera_mat);
